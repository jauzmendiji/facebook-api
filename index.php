			...
			<div class="row pt-3">
				...
				<div class="col-xs-3">
					...
					<?php
						...
						$loginUrl = $helper->getLoginUrl('https://facebook-api-jauzmendiji.c9users.io/email.php', $permissions);
						
						echo '<div><button class="btn"><a href="' . htmlspecialchars($loginUrl) . '">Recibir aviso</a></button></div>';
						
					?>
					
					<div class="fb-like" data-href="https://facebook-api-jauzmendiji.c9users.io/index.php" data-layout="button"
